...
## 🙇‍♀️소감
이번 개인 프로젝트를 진행하며 저는 코드 완성도에 조금 더 집중하고 싶었습니다. 기술을 구현하느라 허겁지겁 작성한 코드가 아닌 완성도 있는 코드를 작성하는 것이 목표였는데 React Native로 첫 개발을 진행하며 예상치 못한 챌린지들을 마주치게 되어 정해진 시간 안에 먼저 기술 구현에 우선순위를 두게되어 개인적으로 굉장히 아쉽습니다. 
